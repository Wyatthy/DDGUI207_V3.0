...
def generator_model_documents(args):
    ...
    shutil.copy(args.work_dir+"/model/fea_ada_trans.hdf5",os.path.join(args.modeldir,'model_exa/fea_ada_trans.hdf5'))
    shutil.copy(args.work_dir+"/model/fit_model.hdf5",os.path.join(args.modeldir,'model_exa/fit_model.hdf5'))
    shutil.copy(args.work_dir+"/model/net_fea.hdf5",os.path.join(args.modeldir,'model_exa/net_fea.hdf5'))
...
if __name__ == '__main__':
    ...
    if not os.path.exists(args.modeldir+'/model_exa'):
        os.makedirs(args.modeldir+'/model_exa')
