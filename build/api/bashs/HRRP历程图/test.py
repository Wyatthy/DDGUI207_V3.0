...
def read_mat(read_path, windows_length, windows_step):
    ...
    for i in range(0, len(folder_name)):
        ...
        for j in range(0, len(class_mat_name)):
            ...
            one_mat_data_win = HRRP_windows_cut(one_mat_data_norm, windows_length, windows_step)
            if j == 0:
...
if __name__ == '__main__':
    ...
    x_test, y_test, folder_name = read_project(project_path, HRRP_picture_length, HRRP_picture_step)
